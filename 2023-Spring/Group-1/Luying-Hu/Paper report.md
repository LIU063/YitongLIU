...
- 纳什均衡：类似于达到了最优解。这是指的博弈中的一个状态，在这个状态下，在其他玩家决策不变的情况下，如果任何一个玩家改变当下的决策，都无法得到更多的好处。
...
## Mean Field Variational Interference
- 设𝑞(𝑠)表示后验分布的变分近似𝑝(𝑆|D)。
- 为了构造一个神经网络来学习分布，对于参数集合{(𝜇1，𝜌1)，…，(𝜇𝑖，𝜌𝑖)，…}，则完全似然可表示为：![40](https://user-images.githubusercontent.com/121794362/228705715-c176123d-e08c-47e3-a830-811e59132dda.png)

- 根据对式(40)中的后验分布𝑝的分析，将式(44)中的后验分布𝑞更新为混合策略，可以得到期望对数似然：![45](https://user-images.githubusercontent.com/121794362/228705726-05805ca2-447d-4161-89e6-96eaf7d56fa3.png)
...
<div align=center><img width="359" alt="表一" src="https://user-images.githubusercontent.com/121794362/228711130-09145058-6e59-41e1-8b86-48be15837f83.png"></div>
