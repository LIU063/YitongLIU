...
## 下一步工作计划
改变各参数，得到不同参数改变后的仿真图<br>
1、改变车辆个数，总的功率、带宽、计算资源不变，时延容忍不变，车辆个数由4-20增加，每次增加两辆车，记录收敛后的cost值。<br>
2、横坐标为改变转换指令大小，然后两三个数据包大小不同，取10Mbit和20Mbit,分别跑三种算法的cost,并且观察当计算指令增加到一定时，cost开始明显增加<br>
3、改变时延容忍，离散图，横坐标为0.01，0.1，0.3，0.5，1，纵坐标为cost<br>
4、改变任务所需周期数，纵坐标可拆分为能量消耗和支付成本<br>

# 本周工作进展（6.29-7.5）
1、制作课题所需要的ppt
2、将知识驱动综述的图表进行进一步修改
3、检查传统算法推导，发现问题并修改
4、传统算法不收敛，调节正迭代步长等参数，还在调参阶段
## 下一步工作计划
1、将三种算法的参数调至合理
...
1、修改仿真实验各参数：
1)车辆个数改为10
2）任务大小改为：1024kbit-2048kbit
3)任务计算所需周期数：200 cycles
4)转换指令计算所需周期数：2 cycles
5)时延容忍度：1s
知识驱动收敛图：
![Figure_1](https://github.com/UNIC-Lab/Weekly-Report/assets/93457144/6ef94e52-6330-453b-bece-e180c6b5ebaf)
...
# 本周工作进展（6.8-6.14）
1、将工作实验仿真的参数设置参考一篇论文设置成合理范围，目前还在修改中<br>
2、完成中期答辩报告，主要是将第二个工作进行梳理，并写入报告，大致内容已完成<br>
3、将综述的图和表进行完善，两个图已修改完成，表的完善还在进行中<br>
![picture1](https://github.com/UNIC-Lab/Weekly-Report/assets/93457144/6f98a081-b7ab-49fb-ad79-99c61af21908)
aa![picture2](https://github.com/UNIC-Lab/Weekly-Report/assets/93457144/6a5c66d7-b883-4861-a4e1-9f90985c2d05)

## 下一步工作计划
1、将中期报告的逻辑进一步完善，答辩后再修改<br>
2、制作中期答辩ppt<br>
3、进一步修改综述中的图表<br>
